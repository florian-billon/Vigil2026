      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-md mx-auto">
          ...
          <p className="mt-4 text-center text-gray-400">
            Already have an account? <Link href="/login" className="text-primary hover:underline focus:outline-none focus:ring-2 focus:ring-primary/50 rounded">Login</Link>
          </p>
        </div>
      </main>
    </div>
